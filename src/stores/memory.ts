...
export class MemoryStore implements StateStore {
  ...
  private readonly wheelSize = 3600; // 1 hour in seconds
  private readonly wheel: TTLWheelSlot[] = [];
  private lastCleanup = Math.floor(Date.now() / 1000);
  ...
  private scheduleExpiration(key: string, entry: CacheEntry, expirationTime: number): void {
