...
export type ScenarioAction = RespondAction | StateSetAction | StatePatchAction | StateIncrementAction | StateDelAction | DelayAction | IfAction | ProxyAction | EmitAction;
...
export interface StateAPI {
    ...
    patch(key: string, value: any, options?: {
        scope?: 'session' | 'global';
    }): Promise<void>;
    increment(key: string, by?: number, options?: {
        scope?: 'session' | 'global';
    }): Promise<number>;
